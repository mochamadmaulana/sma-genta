...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('admin.transaksi.surat-keluar.store') }}" method="POST">
            @csrf
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="penerima" class="form-control @error('penerima') is-invalid @enderror" value="{{ @old('penerima') }}" placeholder="Isi penerima...">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_keluar" class="form-control @error('tanggal_keluar') is-invalid @enderror" value="{{ @old('tanggal_keluar',date('Y-m-d',time())) }}">
                    ...
                    <a href="{{ route('admin.transaksi.surat-keluar.index') }}" class="btn btn-sm btn-danger shadow-sm">
