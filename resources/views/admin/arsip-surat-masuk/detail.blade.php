                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.arsip.surat-masuk.lampiran.download',$file_surat_masuk->id) }}" target="_blank" class="btn btn-xs btn-warning mr-1" ><i class="fas fa-download"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
@push('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('admin.arsip.surat-masuk.index') }}">Cari Arsip</a></li>
