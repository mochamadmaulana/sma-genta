                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.arsip.surat-keluar.lampiran.download',$file_surat_keluar->id) }}" target="_blank" class="btn btn-xs btn-warning mr-1" ><i class="fas fa-download"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
@push('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('admin.arsip.surat-keluar.index') }}">Cari Arsip</a></li>
