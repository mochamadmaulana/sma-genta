            ...
            <div class="col-md">
                <div class="card card-success card-outline">
                    ...
                    <div class="card-body">
                                ...
                                <strong><i class="fas fa-address-card mr-1"></i> KTP</strong>
                                    @if(!empty(Auth::user()->nik_ktp) && !empty(Auth::user()->photo_ktp))
                                        <p class="text-muted">
                                            ...
                                            <a href="{{ route('admin.profile.destroy_ktp') }}" class="badge badge-danger" onclick="return confirm('Yakin, untuk menghapus ktp ?')"><i class="fas fa-trash"></i> Hapus</a>
                                        </p>
                                    @else
                        ...
                        <a href="{{ route('admin.profile.edit') }}" class="btn btn-sm btn-success shadow-sm"><i class="fas fa-pencil-alt mr-1"></i> Edit</a>
                    </div>
                    <!-- /Profile -->
                </div>
            </div>
    ...
    <div class="col-md-3">
        ...
        <div class="card {{ empty(Auth::user()->photo_profile) ? 'card-warning' : 'card-danger' }} card-outline">
            ...
            <div class="card-body box-profile">
                ...
                <form action="{{ route('admin.profile.destroy_photo') }}" method="POST" class="d-inline">
                    @csrf
                    @method('delete')
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.profile.edit_password') }}">
                    @csrf
...
<div class="modal fade" id="ModalEditKtp" tabindex="-1" aria-labelledby="ModalEditKtpLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.profile.edit_ktp') }}" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="ModalUploadKtp" tabindex="-1" aria-labelledby="ModalUploadKtpLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.profile.upload_ktp') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    @csrf
                    <div class="form-group">
                        <div class="form-group">
...
<div class="modal fade" id="ModalUploadPhoto" tabindex="-1" aria-labelledby="ModalUploadPhotoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.profile.upload_photo') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    @csrf
                    <div class="form-group">
...
<div class="modal fade" id="ModalEditPhoto" tabindex="-1" aria-labelledby="ModalEditPhotoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.profile.edit_photo') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    @csrf
                    <div class="form-group">
                        <label>File Photo <span class="text-danger">*</span><br>
