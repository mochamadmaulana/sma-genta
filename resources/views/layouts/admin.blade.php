                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item {{ Request::segment(2) == 'transaksi' ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.transaksi.surat-masuk.index') }}" class="nav-link {{ Request::is('admin/transaksi/surat-masuk*') ? 'active' : '' }}">
                                        <i class="far fa-circle text-sm nav-icon"></i>
                                        <p>Surat Masuk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.transaksi.surat-keluar.index') }}" class="nav-link {{ Request::is('admin/transaksi/surat-keluar*') ? 'active' : '' }}">
                                        <i class="far fa-circle text-sm nav-icon"></i>
                                        <p>Surat Keluar</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{ Request::segment(2) == 'arsip' ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.arsip.surat-masuk.index') }}" class="nav-link {{ Request::is('admin/arsip/surat-masuk*') ? 'active' : '' }}">
                                        <i class="far fa-circle text-sm nav-icon"></i>
                                        <p>Surat Masuk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.arsip.surat-keluar.index') }}" class="nav-link {{ Request::is('admin/arsip/surat-keluar*') ? 'active' : '' }}">
                                        <i class="far fa-circle text-sm nav-icon"></i>
                                        <p>Surat Keluar</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{ Request::segment(2) == 'laporan' ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.laporan.surat-masuk.index') }}" class="nav-link {{ Request::is('admin/laporan/surat-masuk*') ? 'active' : '' }}">
                                        <i class="far fa-circle text-sm nav-icon"></i>
                                        <p>Surat Masuk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.laporan.surat-keluar.index') }}" class="nav-link {{ Request::is('admin/laporan/surat-keluar*') ? 'active' : '' }}">
                                        <i class="far fa-circle text-sm nav-icon"></i>
                                        <p>Surat Keluar</p>
                                    </a>
                                </li>
                        ...
                        <!-- Jabatan -->
                        <li class="nav-item">
                            <a href="{{ route('admin.jabatan.index') }}" class="nav-link {{ Request::is('admin/jabatan*') ? 'active' : '' }}">
                        ...
                        <!-- Jenis Surat -->
                        <li class="nav-item">
                            <a href="{{ route('admin.jenis-surat.index') }}" class="nav-link {{ Request::is('admin/jenis-surat*') ? 'active' : '' }}">
                        ...
                        <!-- Template Surat -->
                        <li class="nav-item">
                            <a href="{{ route('admin.template-surat.index') }}" class="nav-link {{ Request::is('admin/template-surat*') ? 'active' : '' }}">
