...
<div class="container mb-4">
    <form action="{{ route('kepala-sekolah.arsip.surat-masuk.index') }}">
        <div class="row">
            <div class="col-lg-6">
        ...
        <a href="{{ route('admin.arsip.surat-masuk.index') }}" class="btn btn-secondary btn-block"><i class="fas fa-sync-alt mr-1"></i> Refresh</a>
    </form>
</div>
@if($surat_masuk)
<div class="card mt-3">
        ...
        <table id="tableShowSearch" class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('kepala-sekolah.arsip.surat-masuk.detail',$item->id) }}" class="btn btn-xs btn-warning"><i class="fas fa-eye"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
