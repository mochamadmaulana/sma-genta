...
<div class="container mb-4">
    <form action="{{ route('kepala-sekolah.arsip.surat-keluar.index') }}">
        <div class="row">
            <div class="col-lg-6">
        ...
        <a href="{{ route('kepala-sekolah.arsip.surat-keluar.index') }}" class="btn btn-secondary btn-block"><i class="fas fa-sync-alt mr-1"></i> Refresh</a>
    </form>
</div>
@if($surat_keluar)
<div class="card mt-3">
        ...
        <table id="tableShowSearch" class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('kepala-sekolah.arsip.surat-keluar.detail',$item->id) }}" class="btn btn-xs btn-warning"><i class="fas fa-eye"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
