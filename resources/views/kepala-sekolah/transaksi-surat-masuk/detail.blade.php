...
<div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('kepala-sekolah.transaksi.surat-masuk.lampiran.download',$file_surat_masuk->id) }}" target="_blank" class="btn btn-xs btn-warning mr-1" ><i class="fas fa-download"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    Detail Surat Masuk <small class="badge badge-success ml-1">Submited</small>
                </h3>
...
@push('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('kepala-sekolah.transaksi.surat-masuk.index') }}">List Data</a></li>
